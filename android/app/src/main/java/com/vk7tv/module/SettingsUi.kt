        ...
        root.addView(
            note(
                ...
                "По умолчанию коды превращаются в эмоуты только в переписке: " +
                    "в сообщениях диалога и в превью списка чатов. Шапка чата и " +
                    "вкладки внизу остаются как есть. Включи — эмоуты будут везде: " +
                    "в ленте, комментариях, названиях групп. Счётчики непрочитанных " +
                    "не подменяются никогда.",
            ),
        )
