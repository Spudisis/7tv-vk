    ...
    fun ensure(ctx: Context?) {
        ...
        synchronized(this) {
            ...
            if (Config.beginStartup()) {
                ...
                Diag.warn("аварийный режим: эмоуты выключены — клиент падал при запуске. Включить обратно можно в настройках (шестерёнка в пикере или долгий тап по кнопке 7VK).")
