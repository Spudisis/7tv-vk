...
- `[spoiler/]` — под блюром всё сообщение целиком, вместе с фотографиями
  и другими вложениями. Ставится в любом месте текста.

Клик по замазанному месту открывает его насовсем — до того, как ВК
перерисует сообщение. Сами теги в сообщении не показываются, эмоуты
внутри спойлера работают как обычно. Регистр в теге не важен, незакрытый
`[spoiler]` прячет текст до конца сообщения.
