...
между сессиями и ячеек не создают, пока их не раскроешь. Стрелки в заголовке
(появляются при наведении) двигают набор по списку; то же самое — стрелками
в списке наборов в попапе. Глобальный набор и «Свои» стоят по краям и не
двигаются. Порядок задаёт и приоритет: при коллизии кодов голое имя
достаётся набору выше по списку.
