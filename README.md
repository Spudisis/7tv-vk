...
**Наборы сворачиваются.** Клик по заголовку набора прячет его сетку, рядом с
названием видно число эмоутов. Свёрнутые наборы помнятся между сессиями и
ячеек не создают, пока их не раскроешь.
