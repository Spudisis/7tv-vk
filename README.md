...
- Из коробки: глобальный набор 7TV (~45 эмоутов) и набор bratishkinoff
  (~1000). Набор стримера подключается один раз; удалишь из списка — сам
  не вернётся.
...
- «Эмоуты только в мессенджере» — заменять коды лишь в разделе «Мессенджер»
  и диалогах, а ленту, стену и комментарии оставлять текстом.
